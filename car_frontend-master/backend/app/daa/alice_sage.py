...
#### ip data ####
local_ip = '121.248.54.81'
to_ip = '121.248.51.103'
...
def server(device_socket, address, port):
    msgg = "hello i am alice in server"
...
# 连接到云服务器的IP和端口
device_socket.connect((local_ip, port_num))
...
####sign
    ...
    user(device_socket, to_ip, port, W_1,W_1_5,W_2_5,t_1,t_2,c,a_1_T,a_1_T_sig_5,a_2_T,a_2_T_sig_5,z,z_5)
