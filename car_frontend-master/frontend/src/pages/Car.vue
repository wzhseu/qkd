    ...
    <div class="scanboardWp animsition">
      ...
      <div id="main" class="wp clearfix">
            ...
            <div class="itemCon">
              ...
              <div class="infoAuth">
                <div class="authentication" align="center">
                  ...
                  <br>
                  <p><strong v-if="videoState == true">量子加密传输成功！</strong>
                    <strong v-if="videoState == false && DAA == false">等待传输！</strong>
                    <strong v-if="videoState == false && DAA == true">正在传输……</strong>
                  </p>
                </div>
              </div>
              <!-- <div class="infoPie">
        ...
        <div class="center">
            ...
            <div class="item itembg">
              ...
              <div class="itemCon" align="center">
                ...
                <div v-if="videoState == true">
                  <video ref="myVideo" :poster="poster" src="../../../backend/app/q_transfer/result.mp4"
          ...
          <div id="jump" margin="20px">
            <el-button type="primary" style="width:80%;font-size:15px;" @click="skg" round>SKG Details</el-button>
          </div>
          <!-- <div class="exp">
...
export default {
  ...
  data() {
    return {
      ...
      videoSrc: "../../../backend/app/q_transfer/result.mp4"
        ...
        res => {
          ...
          if (this.new_log == true) {
            ...
            for (var i = 0; i < (this.log_spice.length); i++) {
              ...
              if (this.log_spice[i].includes('车A等待视频文件传输', 1) == true) {
              ...
              //   // this.axios.post("/car/A/VCT", param).then(  //if DAA is done, go to VCT
              //   //   res => {
              //   //     console.info('VCT start')
              //   //     const token = res.data;
              //   //     console.info("token:", res.data);
              //   //     // if (token == "True") {
              //   //     //   this.videoState = true;
