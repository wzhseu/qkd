...
# from app.daa.alice_sage import *
...
def server(device_socket, address, port):
    # msgg = "hello i am bob in server"
    # device_socket.send(msgg.encode('utf-8'))
    # answer = (device_socket.recv(1024)).decode('utf-8')
    # print(answer)
...
def generation_log(): 
    ...
    ## This routine is for auto run the skg_client.
    # skg_client.autorun()
